...
export const BlogPost = ({ setView, postId, profileImg, telegram }) => {
      ...
      <>
        ...
        <div className="glass-premium rounded-[32px] p-8 mb-12 border border-[#FF4F4F]/20 relative overflow-hidden">
          ...
          <div className="flex items-start gap-6 relative z-10">
            ...
            <div>
              <h2 className="text-xs font-black text-[#FF4F4F] uppercase tracking-[0.3em] mb-3">Atenção: Risco Global</h2>
              <p className="text-[#F8FAFC] text-sm md:text-base leading-relaxed font-bold italic">
                "A epidemia teve uma grande vantagem inicial e ainda está muito à nossa frente. Estamos jogando um jogo de perseguição. Sem o financiamento imediato de 254 milhões de dólares e acesso seguro às zonas de conflito, corremos o risco de perder o controle total sobre a transmissão."
              </p>
              <p className="text-[#98A2B3] text-xs mt-2">— Dr. Tedros Adhanom Ghebreyesus, Diretor-Geral da OMS.</p>
            </div>
          </div>
        </div>

        <h2 className="text-2xl font-bold text-white mt-10 mb-6 text-pretty tracking-tight">O Desafio da Vigilância e a Variante Bundibugyo</h2>
        <p>Um dos pontos mais preocupantes destacados pela OMS é a alta proporção de mortes ocorrendo dentro das comunidades, em vez de unidades de tratamento. Isso indica que existem cadeias de transmissão invisíveis para as autoridades de saúde. A variante predominante neste surto inclui o vírus <strong>Bundibugyo</strong>, para o qual novas vacinas acabam de entrar na fase 1 de testes em humanos.</p>
        
        <p>Diferente do vírus Zaire, para o qual já existe uma vacina eficaz (Ervebo), a espécie Bundibugyo exige novas soluções terapêuticas. Estudos recentes em animais mostraram evidências promissoras de proteção cruzada, mas a validação clínica em larga escala ainda é necessária e urgente.</p>

        <div className="my-12 relative group">
          <div className="absolute -inset-1 bg-gradient-to-r from-[#FF4F4F] to-[#FF8C4F] rounded-[32px] blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
          <div className="relative bg-black rounded-[32px] overflow-hidden border border-white/10">
            <img src="/assets/ebola_outbreak_2026/ebola_infographic.jpg" alt="Infográfico sobre o surto de Ebola 2026" className="w-full h-auto" />
            <div className="p-6 bg-gradient-to-t from-black/80 to-transparent">
              <p className="text-[#98A2B3] text-xs md:text-sm italic">
                Análise de Impacto: O surto de 2026 na RDC apresenta uma taxa de letalidade superior a 45%, exigindo uma resposta coordenada global.
                <span className="block mt-1 font-bold not-italic text-[#FF4F4F]">Fonte: WHO / Africa CDC / Lancet</span>
              </p>
            </div>
          </div>
        </div>

        <h2 className="text-2xl font-bold text-white mt-10 mb-6 text-pretty tracking-tight">Alerta sobre Políticas de Vacinação</h2>
        <p>Durante o mesmo pronunciamento, o Dr. Tedros expressou profunda preocupação com as recentes mudanças nas políticas de vacinação infantil nos Estados Unidos. A OMS reiterou que atrasar vacinas ou separar doses desnecessariamente, contra o consenso científico, deixa as crianças desprotegidas e vulneráveis a doenças evitáveis como o sarampo.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-12">
          ...
          <div className="bg-white/5 border border-white/10 p-6 rounded-[24px] text-center">
            <div className="text-3xl font-black text-[#FF4F4F] mb-1">US$ 254M</div>
            <div className="text-[10px] font-black text-[#98A2B3] uppercase tracking-widest">Déficit de Financiamento</div>
          </div>
        </div>

        <h2 className="text-2xl font-bold text-white mt-10 mb-6 text-pretty tracking-tight">O que vem agora: Resposta Continental</h2>
        <p>A OMS e o Africa CDC estão escalando a resposta, com o objetivo de triplicar a capacidade de tratamento para 3.000 leitos nas próximas 12 semanas. O sucesso da operação depende da confiança das comunidades locais e da segurança para que os trabalhadores de saúde possam atuar nas frentes de combate ao vírus.</p>

        <div className="bg-[#4F8CFF]/10 border border-[#4F8CFF]/20 rounded-[32px] p-8 my-12">
          <h3 className="text-[#4F8CFF] font-black uppercase tracking-widest text-xs mb-4">Nota Editorial: Dia Internacional da Juventude</h3>
          <p className="text-white font-medium leading-relaxed">
            Hoje também se celebra o Dia Internacional da Juventude. A OMS destacou que os jovens são parceiros críticos na saúde global, sendo essenciais para disseminar informações corretas e combater a desinformação em crises como a do Ebola e nas campanhas de vacinação.
          </p>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/10">
          ...
          <ul className="space-y-4 text-sm text-[#98A2B3]">
            <li className="flex gap-3 italic">
              <span className="text-[#4F8CFF] font-black not-italic">[1]</span>
              World Health Organization (WHO). (2026). Director-General's opening remarks at the media briefing - 12 August 2026.
            </li>
            <li className="flex gap-3 italic">
              <span className="text-[#4F8CFF] font-black not-italic">[2]</span>
              Africa Centres for Disease Control and Prevention (Africa CDC). (2026). Ebola Outbreak in the DRC: Regional Coordination Update.
            </li>
          </ul>
        </div>
      </>
  ...
  useEffect(() => {
    ...
    script.textContent = JSON.stringify({
      ...
      "datePublished": `${postId === "in_vivo_car_t_mrna_2026" || post.date === "12 Ago 2026" || post.date === "12/08/2026" ? "2026-08-12" : "2026-08-11"}T${post.pubTime || "08:00"}:00-03:00`,
      "dateModified": `${postId === "in_vivo_car_t_mrna_2026" || post.date === "12 Ago 2026" || post.date === "12/08/2026" ? "2026-08-12" : "2026-08-11"}T${post.updateTime || post.pubTime || "08:00"}:00-03:00`,
      "author": {
        "@type": "Person",
        "name": "Jeff Queiroz",
