    ...
    <div className="animate-in text-left">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-16">
          <div className="md:w-1/2 flex flex-col items-start">
            ...
            <p className="text-lg md:text-xl text-blue-100/70 font-light mb-10 max-w-lg leading-relaxed">
              O ecossistema completo que integra a <strong>Mentoria Aprovado</strong> e os{" "}
              <strong>Flashcards Aprovado</strong>.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <button
                onClick={() => setView('materials')}
                className="bg-white text-[#0A192F] px-8 py-4 rounded-full font-black text-xs uppercase shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="bg-blue-600/20 text-white border border-blue-400/30 px-8 py-4 rounded-full font-black text-xs uppercase hover:bg-blue-600/40 transition-all flex items-center justify-center gap-2 backdrop-blur-sm"
              >
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-[10px] text-green-300 font-bold uppercase leading-none">
                        Redação
                      </p>
                      <p className="text-sm font-black text-white">
                        920 (Média da Mentoria)
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <p className="text-[10px] text-blue-300 font-bold uppercase leading-none">
                        Natureza
                      </p>
                      <p className="text-sm font-black text-white">
                        Biologia: 92% | Química: 88%
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <span className="text-[#2E70CE] font-black text-[10px] uppercase tracking-[0.3em]">
            MÉTODO VESTIBULAR
          </span>
          <h2 className="text-4xl font-black text-[#0A192F] mt-4 italic uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
            ...
            <h3 className="text-xl font-black text-[#0A192F] mb-4 uppercase italic">
              Inspiração Real
            </h3>
            <p className="text-gray-600 text-sm leading-relaxed">
              Mostramos a rotina na UFMG para transformar o teu sonho em combustível diário.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Flashcards e cronogramas focados na FUVEST e ENEM.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Suporte real de quem já trilhou esse caminho com sucesso.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20 border-y border-gray-100 text-center">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div key={i}>
              <p className={`text-4xl md:text-5xl font-black ${item.color} italic`}>
                {item.val}
              </p>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white p-12 md:p-20 rounded-[50px] shadow-2xl relative overflow-hidden border border-gray-100 text-left">
            ...
            <div className="relative z-10">
              <p className="text-2xl md:text-3xl font-bold text-gray-800 italic leading-relaxed mb-10">
                "A estratégia da Mentoria Aprovado aliada aos cronogramas fez-me alcançar
                920 na redação e dominar a prova de Natureza."
              </p>

              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center text-white font-black">
                  M
                </div>
                <div>
                  <p className="font-black text-[#0A192F] uppercase text-sm">
                    Mariana C.
                  </p>
