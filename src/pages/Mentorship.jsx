...
export const Mentorship = ({ telegram }) => (
  <div className="py-40 text-center flex flex-col items-center gap-8 animate-in zoom-in duration-500 px-6">
    ...
    <a href={telegram} target="_blank" rel="noreferrer" className="bg-[#2E70CE] text-white px-10 py-4 rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl hover:shadow-2xl hover:scale-105 transition-all">Entrar na Lista de Espera</a>
  </div>
);
