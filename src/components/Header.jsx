  ...
  return (
    <>
      <header className="w-full sticky top-0 z-50">
        <div className="bg-[#4F8CFF] text-[#080A0F] py-1.5 px-4 flex justify-center items-center text-[10px] font-black uppercase tracking-[0.25em] gap-2 text-center">
          <Zap size={10} className="text-[#080A0F]" aria-hidden="true" />
          <span>Portal Editorial de Medicina, Ciência e Educação</span>
        </div>
        
        <div className="bg-[#080A0F]/90 backdrop-blur-xl border-b border-white/[0.05] py-3 px-4 md:px-8">
          <div className="max-w-7xl mx-auto flex justify-between items-center gap-4">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden lg:flex gap-1 text-xs font-bold uppercase tracking-wider text-[#98A2B3]" aria-label="Navegação principal">
                {[
                  ['home', 'Início'],
                  ['news', 'Notícias'],
                  ['materials', 'Materiais'],
            ...
            <div className="flex items-center gap-3 shrink-0">
              <button
                ...
                className="bg-white/[0.03] text-[#98A2B3] hover:text-white px-3 py-2 rounded-lg border border-white/[0.08] hover:bg-white/[0.06] transition-all flex items-center gap-2 text-xs font-bold"
              ...
              <button
                ...
                className="bg-white/[0.05] text-white text-[10px] font-black uppercase px-4 py-2.5 rounded-lg border border-white/[0.08] hover:bg-white/[0.1] transition-all focus:outline-none"
              >
                Biblioteca
              </button>
              <a
                ...
                rel="noreferrer"
                aria-label="Telegram"
                className="bg-[#4F8CFF] text-[#080A0F] p-2.5 rounded-lg hover:bg-[#7EA6FF] transition-all focus:outline-none shadow-[0_0_20px_rgba(79,140,255,0.2)]"
              >
